...
BEGIN
  ...
  -- Auto-approve students, keep others pending review
...
-- Set department/level on seeded profile records (generated by trigger)
UPDATE public.profiles
SET department_id = 'c0a80101-0000-0000-0000-000000000001'
WHERE id IN ('a0a80103-0000-0000-0000-000000000002', 'a0a80103-0000-0000-0000-000000000003');

UPDATE public.profiles
SET level_id = 'c0a80102-0000-0000-0000-000000000001'
WHERE id = 'a0a80103-0000-0000-0000-000000000003';
